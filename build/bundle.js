...
/******/ 	var hotCurrentHash = "0f30c2187ae6d94dc6b9"; // eslint-disable-line no-unused-vars
...
// module
exports.push([module.i, "header button {\n  margin: 0.53333rem 0;\n}\nheader h3 {\n  color: red;\n}\nheader div {\n  margin-bottom: 0.66667rem;\n}\n", ""]);
...
var _reduxPromise = __webpack_require__(72);
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_header2.default, { title: this.state.title, refs: 'header' })
      );
    }
  }]);
...
var _fluxStandardAction = __webpack_require__(73);
...
var _lodashIsplainobject = __webpack_require__(74);
...
var Header = function (_Component) {
  ...
  function Header(props) {
    ...
    _this.MyaddCount = _this.MyaddCount.bind(_this);
    return _this;
  }

  _createClass(Header, [{
    key: 'MyaddCount',
    value: function MyaddCount() {
      var _this2 = this;
      ...
      setTimeout(function () {
        dispatch((0, _actions.addCount)());
        console.log('\u70B9\u51FB\u540E\uFF1A' + _this2.props.count);
      }, 500);
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: this.MyaddCount },
          'Add'
        ),
        _react2.default.createElement(
          'div',
          null,
          '\u5F53\u524D\u503C\uFF1A' + this.props.count + '\uFF0C\u6253\u5F00F12\u67E5\u770B'
        )
      );
    }
  }]);
...
var addReducers = (0, _redux.combineReducers)({
  count: count
});
